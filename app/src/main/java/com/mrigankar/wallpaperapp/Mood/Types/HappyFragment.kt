...
@AndroidEntryPoint
class HappyFragment : BaseFragment<FragmentHappySadBinding, HappyViewModel>(), ImageAdapterListener {
    ...
    override fun getViewModelClass(): Class<HappyViewModel>? {
        return HappyViewModel::class.java
...
//        }
        ...
        viewModel.getHappyCategoriesData()
    ...
    override fun onImageClicked(image: ImageViewData) {
        findNavController().navigate(
            HappyFragmentDirections.actionHappyFragmentToSetWallpaperFragment(image)
        )
    }
}
